...
def gen_m3u_file(channels, channel_info):
    ...
    for channel in channels:
        ...
        f.write(f"#EXTINF:-1 tvg-id=\"{tvg_id}\" tvg-name=\"{tvg_name}\" tvg-logo=\"{tvg_logo}\" catchup=\"default\" catchup-days=\"5\" catchup-source=\"{catch_source}?playseek=${{(b)yyyyMMddHHmmss}}-${{(e)yyyyMMddHHmmss}}\" group-title=\"{group_title}\",{channel['name']}\n")
